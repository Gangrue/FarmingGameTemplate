...
function define_items(){
	...
	//tomato,
	define_item(ITEMS.TOMATO, 255, "Tomato", "A Tasty Tomato", ITEM_TYPE.FOOD, 5, consume_food, "HP+5,CONSUME");
	define_item(ITEMS.TOMATOSEED, 255, "Tomato Seed", "Grows a Tomato Plant", ITEM_TYPE.SEED, 30, empty_script, crop.tomato);
	//potato,
	define_item(ITEMS.POTATO, 255, "Potato", "A Tasty potato", ITEM_TYPE.FOOD, 5, consume_food, "HP+5,CONSUME");
	define_item(ITEMS.POTATOSEED, 255, "Potato Seed", "Grows an potato", ITEM_TYPE.SEED, 30, empty_script, crop.potato);
	//carrot,
	define_item(ITEMS.CARROT, 255, "Carrot", "A Tasty Carrot", ITEM_TYPE.FOOD, 5, consume_food, "HP+5,CONSUME");
	define_item(ITEMS.CARROTSEED, 255, "Carrot Seed", "Grows a Carrot", ITEM_TYPE.SEED, 30, empty_script, crop.carrot);
	//artichoke,
	define_item(ITEMS.ARTICHOKE, 255, "Artichoke", "A Tasty Artichoke", ITEM_TYPE.FOOD, 5, consume_food, "HP+5,CONSUME");
	define_item(ITEMS.ARTICHOKESEED, 255, "Artichoke Seed", "Grows an Artichoke", ITEM_TYPE.SEED, 30, empty_script, crop.artichoke);
	//chilli,
	define_item(ITEMS.CHILLI, 255, "Chili", "A Tasty Chili", ITEM_TYPE.FOOD, 5, consume_food, "HP+5,CONSUME");
	define_item(ITEMS.CHILLISEED, 255, "Chili Seed", "Grows a Chili", ITEM_TYPE.SEED, 30, empty_script, crop.chilli);
	//gourd,
	define_item(ITEMS.GOURD, 255, "Gourd", "A Tasty Gourd", ITEM_TYPE.FOOD, 5, consume_food, "HP+5,CONSUME");
	define_item(ITEMS.GOURDSEED, 255, "Gourd Seed", "Grows a Gourd", ITEM_TYPE.SEED, 30, empty_script, crop.gourd);
	//corn
	define_item(ITEMS.CORN, 255, "Corn", "A Tasty Corn", ITEM_TYPE.FOOD, 5, consume_food, "HP+5,CONSUME");
	...
	define_item(ITEMS.TREESEED, 255, "Tree Sapling", "Grows a Tree", ITEM_TYPE.TREESEED, 2, empty_script, "TreePlant");
